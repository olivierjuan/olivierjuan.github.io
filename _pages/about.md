...
<script>
(function () {
  fetch('https://ipapi.co/org/')
    .then(function (r) { return r.text(); })
    .then(function (org) {
      var lower = org.toLowerCase();
      if (lower.includes('edf') || lower.includes('electricite de france')) {
        var el = document.getElementById('open-to-work-banner');
